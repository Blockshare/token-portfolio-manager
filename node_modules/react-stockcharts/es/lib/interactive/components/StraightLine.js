...
function getXLineCoordinates(_ref4) {
	...
	var _ref5 = end[0] > start[0] ? [xBegin, xFinish] : [xFinish, xBegin],
...
function getRayCoordinates(_ref7) {
...
function getLineCoordinates(_ref8) {
...
export function generateLine(_ref9) {
	var type = _ref9.type,
	    start = _ref9.start,
	    end = _ref9.end,
	    xScale = _ref9.xScale,
