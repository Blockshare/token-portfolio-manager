...
exports.runBitcoinAddressBasedProofsUnitTests = runBitcoinAddressBasedProofsUnitTests;
...
function mockRequests() {
  ...
  _fetchMock2.default.get(naval.github.url, naval.github.body);
...
function runProofStatementUnitTests() {
  (0, _tape2.default)('getProofStatement', function (t) {
    ...
    t.equal(_lib.profileServices.github.getProofStatement(naval.github.body), 'Verifying that +naval is my Bitcoin username. You can send me #bitcoin here: https://onename.io/naval', 'Should extract proof statement from Github page body');

    t.equal(_lib.profileServices.twitter.getProofStatement(ken.twitter.body), 'Verifying my avatar on Blockstack is owned by the address 1AtFqXxcckuoEN4iMNNe7n83c5nugxpzb5', 'Should extract address-based proof statement from Twitter page meta tags');

    t.equal(_lib.profileServices.github.getProofStatement(ken.github.body), 'Verifying my avatar on Blockstack is owned by the address 1AtFqXxcckuoEN4iMNNe7n83c5nugxpzb5', 'Should extract address-based proof statement from Github page body');

    t.equal(_lib.profileServices.instagram.getProofStatement(ken.instagram.body), 'Verifying my avatar on Blockstack is owned by the address 1AtFqXxcckuoEN4iMNNe7n83c5nugxpzb5', 'Should extract address-based proof statement from Instagram meta tags');

    t.equal(_lib.profileServices.hackerNews.getProofStatement(ken.hackerNews.body), 'Verifying my avatar on Blockstack is owned by the address 1AtFqXxcckuoEN4iMNNe7n83c5nugxpzb5', 'Should extract address-based proof statement from Hacker News profile');

    t.equal(_lib.profileServices.linkedIn.getProofStatement(ken.linkedIn.body), 'Verifying my avatar on Blockstack is owned by the address 1AtFqXxcckuoEN4iMNNe7n83c5nugxpzb5', 'Should extract address-based proof statement from Hacker News profile');
  });
}

function runBitcoinAddressBasedProofsUnitTests() {
  (0, _tape2.default)('containsValidBitcoinProofStatement', function (t) {
    t.plan(12);
    ...
    t.equals((0, _lib.containsValidBitcoinProofStatement)(facebookProofStatement, '1EyuZ8qxdhHjcnTChwQLyQaN3cmdK55DkH', true), true, "Facebook post meta tags should contain valid bitcoin address proof statement");

    t.equals((0, _lib.containsValidBitcoinProofStatement)(facebookProofStatement, 'differentBitcoinAddress', true), false, "Facebook post meta tags should not contain valid bitcoin address proof statement");

    t.equals((0, _lib.containsValidBitcoinProofStatement)(twitterProofStatement, '1AtFqXxcckuoEN4iMNNe7n83c5nugxpzb5', true), true, "Twitter status meta tags should contain valid bitcoin address proof statement");

    t.equals((0, _lib.containsValidBitcoinProofStatement)(twitterProofStatement, 'differentBitcoinAddress', true), false, "Twitter status meta tags should not contain valid bitcoin address proof statement");

    t.equals((0, _lib.containsValidBitcoinProofStatement)(githubProofStatement, '1AtFqXxcckuoEN4iMNNe7n83c5nugxpzb5', true), true, "Github gist body should contain valid bitcoin address proof statement");

    t.equals((0, _lib.containsValidBitcoinProofStatement)(githubProofStatement, 'differentBitcoinAddress', true), false, "Github gist body should not contain valid bitcoin address proof statement");

    t.equals((0, _lib.containsValidBitcoinProofStatement)(instagramProofStatement, '1AtFqXxcckuoEN4iMNNe7n83c5nugxpzb5', true), true, "Instagram body should contain valid bitcoin address proof statement");

    t.equals((0, _lib.containsValidBitcoinProofStatement)(instagramProofStatement, 'differentBitcoinAddress', true), false, "Instagram body should not contain valid bitcoin address proof statement");

    t.equals((0, _lib.containsValidBitcoinProofStatement)(hackerNewsProofStatement, '1AtFqXxcckuoEN4iMNNe7n83c5nugxpzb5', true), true, "Hacker News body should contain valid bitcoin address proof statement");

    t.equals((0, _lib.containsValidBitcoinProofStatement)(hackerNewsProofStatement, 'differentBitcoinAddress', true), false, "Hacker News body should not contain valid bitcoin address proof statement");

    t.equals((0, _lib.containsValidBitcoinProofStatement)(linkedInProofStatement, '1AtFqXxcckuoEN4iMNNe7n83c5nugxpzb5', true), true, "Hacker News body should contain valid bitcoin address proof statement");

    t.equals((0, _lib.containsValidBitcoinProofStatement)(linkedInProofStatement, 'differentBitcoinAddress', true), false, "Hacker News body should not contain valid bitcoin address proof statement");
  });
}
...
function runProofServicesUnitTests() {
  ...
  (0, _tape2.default)('get proof url', function (t) {
    ...
    t.equal(_lib.profileServices.github.getProofUrl(_sampleData.sampleProofs.naval[2]), "https://gist.github.com/navalr/f31a74054f859ec0ac6a", "Github proof URL should match reference");
    ...
    t.throws(function () {
      var notLarry = Object.assign({}, _sampleData.sampleProofs.larry[0], {
        proof_url: 'https://www.facebook.com/not.larry/posts/10100341028448093'
      });
      _lib.profileServices.facebook.getProofUrl(notLarry);
